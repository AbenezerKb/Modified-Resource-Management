...
namespace ERP.Migrations
{
    ...
    [Migration("20220502080821_TestA22")]
    partial class TestA22
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERP.Models.BulkPurchaseItem", b =>
                {
                    ...
                    b.HasKey("BulkPurchaseId", "ItemId");
            ...
            modelBuilder.Entity("ERP.Models.PurchaseItemSite", b =>
                {
                    b.Property<int>("PurchaseId")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("RequestSiteId")
                        .HasColumnType("int");

                    b.Property<int>("RequestingSiteId")
                        .HasColumnType("int");

                    b.HasKey("PurchaseId", "ItemId", "RequestSiteId");

                    b.HasIndex("ItemId");

                    b.HasIndex("RequestingSiteId");

                    b.ToTable("PurchaseItemSites");
                });
            ...
            modelBuilder.Entity("ERP.Models.PurchaseItemSite", b =>
                {
                    ...
                    b.HasOne("ERP.Models.Site", "Site")
                        .WithMany()
                        .HasForeignKey("RequestingSiteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
