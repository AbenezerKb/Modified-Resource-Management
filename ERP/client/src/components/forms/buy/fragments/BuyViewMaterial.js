...
function BuyViewMaterial({ addedItems, index }) {
  return (
    <>
      <div className="shadow pt-3 px-4 mb-4 rounded">
        ...
        <div className="row">
          ...
          <div className="col">
            ...
            {addedItems[index].qtyApproved > 0 && (
              <div className="row">
                <div className="col">
                  <Form.Group className="mb-3">
            ...
            {addedItems[index].qtyBought > 0 && (
              <div className="row">
                <div className="col">
                  <Form.Group className="mb-3">
                    ...
                    <Form.Control
                      type="text"
                      name="qtySent"
                      value={addedItems[index].qtyBought}
                      readOnly
                    />
                  </Form.Group>
                </div>
                <div className="col">
                  <Form.Group className="mb-3">
                    <Form.Label>Bought Total Cost</Form.Label>
                    <Form.Control
                      type="text"
                      name="total"
                      readOnly
                      value={
                        addedItems[index].qtyBought * addedItems[index].cost
                      }
                    />
                  </Form.Group>
                </div>
        ...
        <div className="row">
          ...
          <div className="col">
            <Form.Group className="mb-3">
              <Form.Label>Buy Remark</Form.Label>
              <Form.Control
                type="text"
                name="buyRemark"
                value={addedItems[index].buyRemark}
                readOnly
              />
            </Form.Group>
          </div>
      ...
      <tr className="d-none d-print-table-row">
        ...
        <td>{addedItems[index].qtyBought}</td>
        ...
        <td>{addedItems[index].buyRemark}</td>
      </tr>
    </>
  )
}

BuyViewMaterial.propTypes = {
  addedItems: PropTypes.array.isRequired,
  index: PropTypes.number.isRequired,
}

export default BuyViewMaterial
