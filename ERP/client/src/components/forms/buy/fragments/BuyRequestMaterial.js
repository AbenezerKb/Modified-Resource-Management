...
function BuyRequestMaterial({ allItems, addedItems, setAddedItems, index }) {
  function selectedItemChanged(e) {
    ...
    var item = allItems.filter(
      (item) => item.itemId.toString() === selectedId
    )[0]
                ...
                allItems
                  .filter(
                    (currentItem) =>
                      addedItems.filter(
                        (addedItem) =>
                          addedItem.itemId === currentItem.itemId.toString() &&
                          addedItem.itemId !== addedItems[index].itemId
                      ).length === 0
                  )
                  .map((item) => (
            ...
            <div className="col">
              <Form.Group className="mb-3">
                ...
                <Form.Control
                  ...
                  name="total"
                  value={
                    addedItems[index].cost * addedItems[index].qtyRequested
                  }
                />
              </Form.Group>
            </div>
...
export default BuyRequestMaterial
