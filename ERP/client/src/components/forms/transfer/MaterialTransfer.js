...
import TransferRequestMaterial from "./fragments/TransferRequestMaterial";
import Header from "../../layouts/Header";
import { useNavigate } from "react-router-dom";
import { useQuery, useMutation } from "react-query";
import { fetchSites } from "../../../api/site";
import { fetchTransferableMaterials } from "../../../api/item";
...
function MaterialTransfer() {
    ...
    const itemQuery = useQuery("materials", fetchTransferableMaterials, {
    ...
    } = useMutation(requestMaterialTransfer, {
    ...
    return (
        <>
            <Header title="New Material Transfer Request" />
